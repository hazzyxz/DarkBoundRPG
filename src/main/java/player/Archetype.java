...
public abstract class Archetype {
    ...
    public Archetype(String[] baseStats) {
        ...
        this.stats[0] = Integer.parseInt(baseStats[1]);
        this.stats[1] = Integer.parseInt(baseStats[2]);
        this.stats[2] = Integer.parseInt(baseStats[3]);
        this.stats[3] = Integer.parseInt(baseStats[4]);
        this.stats[4] = Integer.parseInt(baseStats[5]);
        this.stats[5] = Integer.parseInt(baseStats[6]);
        this.level = 1;
