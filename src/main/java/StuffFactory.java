...
public class StuffFactory {
    ...
    public Creature newNpc(){
        ...
        Creature npc = new Creature(world, "Damsel",'N', AsciiPanel.brightMagenta, 1, 1, 1, 1,1,1,"src/main/java/asciiArt/test ascii.txt");
    ...
    public Creature newFungus(){
        ...
        Creature fungus = new Creature(world, "fungus",'f', AsciiPanel.brightRed, 100, 10, 10, 10,10,10,"src/main/java/asciiArt/test ascii.txt");
    ...
    public Creature newBat(){
        Creature bat = new Creature(world, "bat",'b', AsciiPanel.brightRed, 150, 15, 10, 10, 10, 10,"src/main/java/asciiArt/test ascii 2.txt");
